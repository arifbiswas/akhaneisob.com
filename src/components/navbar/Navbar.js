...
import { FaBars ,FaHome ,FaFacebookSquare,FaYoutube ,FaFolderPlus } from "react-icons/fa";
    ...
    return (
        <div className=" bg-green-700 shadow-2xl drop-shadow-2xl w-full flex justify-between items-center py-4 px-5 gap-4 ">
            ...
            <div className="hidden lg:block ">
                ...
                <Link href="/admin" className="px-4 py-2 text-white flex items-center gap-1">

        ...
        <div className='bg-green-700 h-[96] rounded-lg border-2 border-green-500 shadow-lg shadow-green-500' >
            ...
            <div className=''>
              <div className='flex flex-col items-center justify-between p-4'>
                ...
                <p className='text-gray-200 text-sm text-center my-1'>{site?.description.slice(0,50)}</p>
                <Link href={`/categories/product/${site?.id}`}  
                className="mt-4"
                ><WhiteButton text={"View Details"} css={"bg-green-900 text-white"}/> </Link>
              </div>
            </div>
        </div>
    );

        ...
        <div className=" bg-green-700 rounded-md p-5 border-4 border-green-600 shadow-xl shadow-green-500 text-white flex flex-col justify-between">
          <div>
            ...
            <p className="text-green-200 mt-5">
              this is new Newspaper you can use your professional news website
              as like your comapany logo and we should know news channel and
              news categories any compnay need web portal current situation adn{" "}
            </p>
          </div>
            ...
            <SwiperSlide key={index}>
              <div className="bg-green-600 p-3 mb-5 h-56 rounded-md text-white shadow-lg drop-shadow-lg shadow-green-500">
                <div className="flex items-center gap-5">
                  <img
                    className="w-24 h-24 rounded-full border-2 border-green-500 shadow-lg shadow-green-500"
                ...
                <p className="bg-green-700 w-full text-sm rounded-md p-3 mt-3 text-center h-24 overflow-hidden">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum
                  nulla rem cupiditate, nisi nesciunt qui ad....more
                </p>
              </div>
            </SwiperSlide>
          ))}
